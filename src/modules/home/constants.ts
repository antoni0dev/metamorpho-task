export const mmFactoryAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'metaMorpho', type: 'address' },
      { indexed: true, internalType: 'address', name: 'caller', type: 'address' },
      { indexed: false, internalType: 'address', name: 'initialOwner', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'initialTimelock', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'createMetaMorpho',
    outputs: [{ internalType: 'contract IMetaMorpho', name: 'metaMorpho', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'function'
  },
  {
...
export const INPUT_DEBOUNCE_DELAY = 350;
